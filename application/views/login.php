            ...
            <div class="container"> 
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="<?= site_url('construction/cart') ?>" id="cart-popover" onclick="login1()" class="btn" data-placement="bottom" title="Carrinho de Compras">
                            <!--<span class="glyphicon glyphicon-shopping-cart"></span>-->
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                <i class="fa fa-shopping-cart pl-0" ></i><?php echo $user ?>
                            </a>
                        </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="service-desc">
                            <button type="button" value="BRICKS" class="btn btn-success" onclick="pay(value);
                                    changeimg(value)">Buy</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="service-desc">
                            <button type="button" class="btn btn-success" value="BAALU"onclick="pay(value);
                                    changeimg(value)">Buy</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="service-desc">
                            ...
                            <button type="button" class="btn btn-success" value="Rait"onclick="pay(value);
                                    changeimg(value)">Buy</button>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="service-desc">
                            ...
                            <button type="button" class="btn btn-success" value="Sariya" onclick="pay(value);
                                    changeimg(value)">Buy</button>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="service-media"> <img src="<?php echo base_url("assets/img/gravels_f.jpg") ?>" id="Windows and Doors"alt=" "> </div>
                        <h3>GRAVELS</h3>
                        ...
                        <div class="service-desc">
                            ...
                            <button type="button" class="btn btn-success" value="Windows & Doors" onclick="pay(value);
                                    changeimg(value)">Buy</button>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="service-desc">
                            ...
                            <button  type="button" class="btn btn-success" value="Aluminium Cabinet" onclick="pay(value);
                                    changeimg
                                            (value)">Buy</button>
